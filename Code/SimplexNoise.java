public class SimplexNoise { 
    ...
    public static double noise(double xin, double yin) {
        double n0, n1, n2; 
        final double f2 = 0.5*(Math.sqrt(3.0)-1.0); double s = (xin+yin)*f2; 
        ...
        return (70.0 * (n0 + n1 + n2)+1.0)/2;
    }
    public static double noiseOctaves(double x, double y, int octaves, double persistence){
		double total = 0;
		double frequency = 1;
		double amplitude = 1;
		double maxValue = 0;
